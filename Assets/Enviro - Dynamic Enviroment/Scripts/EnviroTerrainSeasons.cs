...
public class EnviroTerrainSeasons : MonoBehaviour {
	...
	void Update ()
	{
		if (ChangeGrassWind && EnviroSky.instance.Weather.currentActiveWeatherID != null) 
		{
			terrain.terrainData.wavingGrassStrength = EnviroSky.instance.Weather.currentActiveWeatherID.WindStrenght * windSpeedModificator;
			terrain.terrainData.wavingGrassSpeed = EnviroSky.instance.Weather.currentActiveWeatherID.WindStrenght * windSizeModificator;
		}
	}
}
